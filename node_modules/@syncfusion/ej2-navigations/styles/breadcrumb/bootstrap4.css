...
.e-breadcrumb .e-breadcrumb-item .e-breadcrumb-icon.e-icon-item {
  padding: 0;
}
...
.e-bigger.e-breadcrumb .e-breadcrumb-item .e-breadcrumb-text .e-breadcrumb-icon.e-icon-item,
.e-bigger .e-breadcrumb .e-breadcrumb-item .e-breadcrumb-text .e-breadcrumb-icon.e-icon-item {
  padding: 0;
}
...
.e-breadcrumb .e-breadcrumb-item:hover .e-breadcrumb-icon.e-icon-item, .e-breadcrumb .e-breadcrumb-item:active .e-breadcrumb-icon.e-icon-item, .e-breadcrumb .e-breadcrumb-item.e-focus .e-breadcrumb-icon.e-icon-item {
  color: #6610f2;
}
