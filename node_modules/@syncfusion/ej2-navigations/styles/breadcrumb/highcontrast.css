...
.e-bigger .e-breadcrumb .e-home::before,
.e-bigger.e-breadcrumb .e-home::before {
  margin-top: 2px;
}
...
.e-breadcrumb .e-breadcrumb-item:not(:last-child):not(.e-breadcrumb-separator).e-focus {
...
.e-breadcrumb .e-breadcrumb-item:active .e-breadcrumb-icon {
  color: #000;
}
