//month view
$calendar-normal-month-view-height: 27px !default;
...
//bgcolor
$calendar-header-font-color: $grey-dark-font !default;
$calendar-header-icon-color: $grey-dark-font !default;
$calendar-title-font-color: $calendar-header-icon-color !default;
$calendar-icon-font-color: $grey-dark-font !default;
...
$calendar-border-style: 1px solid rgba($grey-44, 100%) !default;
$calendar-bg-color: $grey-base !default;
...
$calendar-yeardecade-hover-bg: $grey-88 !default;
$calendar-yeardecade-selected-hover-bg: darken($brand-primary, 10%) !default;
...
$calendar-other-month-date: $grey-lighter !default;
$calendar-other-month-date-hover-bg: $grey-lighter !default;
...
$calendar-active-bg-border-color: 1px solid $brand-primary !default;
$calendar-active-hover-bg-color: darken($brand-primary, 10%) !default;
$calendar-hover-color:  $grey-88 !default;
$calendar-text-color: $grey-dark-font !default;
$calendar-hover-text: $calendar-text-color !default;
$calendar-focus-bg-color: $grey-88 !default;
$calendar-focused-today-bg-style: $grey !default;
$calendar-focused-today-border-style:  1px solid $brand-primary !default;
$calendar-focus-border-color: none !default;
$calendar-hover-border-color: none !default;
$calendar-disable-font-color: $grey-8c !default;
...
$calendar-focused-date-bg-style: $grey-88 !default;
...
//week header
$calendar-week-header-font-color: $grey-dark-font !default;
...
$calendar-week-number-color-style: $grey-lighter !default;
...
$calendar-small-title-font-color: $grey-dark-font !default;
