...
@mixin outline-primary-disabled {
  @if $skin-name == 'bootstrap5' {
    background-color: $btn-outline-primary-disabled-border-color;
  }
  @else {
    background-color: $btn-outline-bgcolor;
  }
...
@mixin outline-success-disabled {
  @if $skin-name == 'bootstrap5' {
    background-color: $btn-outline-success-disabled-border-color;
  }
  @else {
    background-color: $btn-outline-bgcolor;
  }
...
@mixin outline-info-disabled {
  @if $skin-name == 'bootstrap5' {
    background-color: $btn-info-disabled-border-color;
  }
  @else {
    background-color: $btn-outline-bgcolor;
  }
...
@mixin outline-warning-disabled {
  @if $skin-name == 'bootstrap5' {
    background-color: $btn-outline-warning-disabled-border-color;
  }
  @else {
    background-color: $btn-outline-bgcolor;
  }
...
@mixin outline-danger-disabled {
  @if $skin-name == 'bootstrap5' {
    background-color: $btn-outline-danger-disabled-border-color;
  }
  @else {
    background-color: $btn-outline-bgcolor;
  }
