...
export class Dialog extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private onResizing(args: ResizingMouseEventArgs | ResizingTouchEventArgs, dialogObj: Dialog): void {
        args.height = formatUnit(this.element.offsetHeight);
    ...
    private wireEvents(): void {
        if (this.isBlazorServerRender() && this.showCloseIcon) {
            this.closeIcon = this.element.getElementsByClassName('e-dlg-closeicon-btn')[0] as HTMLElement;
        }
        if (this.showCloseIcon) {
            EventHandler.add(
...
interface ResizingMouseEventArgs extends MouseEvent  {
    height?: string
}
...
interface ResizingTouchEventArgs extends TouchEvent  {
    height?: string
}